...
class LandingApply(models.Model):
    ...
    def __str__(self):
        return "{}::{}".format(self.apply_name, self.apply_birth)
...
class Item(models.Model):
    ...
    item_content = models.TextField(verbose_name="상세페이지")

    item_img = models.ImageField(upload_to='onedeal/%Y/%m/%d', blank=True, verbose_name="이미지")

    item_created = models.DateTimeField(verbose_name="생성일자")
